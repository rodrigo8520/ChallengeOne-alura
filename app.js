...
(function () {
  ...
  function uiSoloLetras(ev) {
    ...
    if (inputType === "insertText") {
      ...
      if (target.value !== value) {
        alert(
          "se ha modificado el texto para coincidir con los carácteres permitidos"
        );
      }
    }
  }
  ...
  function uiDecodificar() {
    ...
    if (txt.length === 0) {
      ...
      try {
        ...
        salida.nodeValue =
          "Error: no se pudo decodificar la cadena,  no es válido";
      }
      mostrarResultado();
    }
  }
  ...
  function uiCopiar() {
    ...
    if (kClipboard) {
      kClipboard.writeText(salida.nodeValue).then(() => alert("copiado"));
    }
  }
})
();
